...
Mock-data retry now stays on the mock route (`/migrations/<runId>`) and cannot accidentally invoke the authoritative HomePage restoration flow. The regression was captured RED and is covered by the focused route suite.
