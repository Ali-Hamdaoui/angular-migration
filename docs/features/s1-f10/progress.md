...
- Full validation: backend `250 passed, 2 skipped`; frontend `17 test files, 43 tests passed`; frontend TypeScript check and production build passed; Alembic upgrade to head passed on temporary SQLite.
