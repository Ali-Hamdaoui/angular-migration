...
export const AUTHORITATIVE_EVENT_TYPES = ["RUN_CREATED", "RUN_START_ACCEPTED", "RUN_STARTED", "RUN_START_REJECTED", "run_state_changed", "SOURCE_INTAKE_QUEUED", "SOURCE_INTAKE_STARTED", "SOURCE_INTAKE_COMPLETED", "SOURCE_INTAKE_FAILED", "RUN_RECONSTRUCTED", "SNAPSHOT_STARTED", "SNAPSHOT_CREATED", "SNAPSHOT_FAILED", "SNAPSHOT_PROGRESS_UPDATED", "SNAPSHOT_QUARANTINED", "SOURCE_INTEGRITY_VERIFIED", "SOURCE_INTEGRITY_FAILED", "G02_CREATED", "G02_APPROVED", "G02_REJECTED", "G02_STALE", "ANALYSIS_AGENT_STARTED", "ANALYSIS_AGENT_COMPLETED", "ANALYSIS_AGENT_FAILED", "ANALYSIS_REVIEWER_STARTED", "ANALYSIS_REVIEWER_COMPLETED", "ANALYSIS_REVIEWER_FAILED", "ANALYSIS_INPUT_VALIDATION_STARTED", "ANALYSIS_INPUT_VALIDATION_COMPLETED", "ANALYSIS_CONTEXT_PREPARED", "LLM_REQUEST_PREPARED", "LLM_HTTP_REQUEST_STARTED", "LLM_HTTP_RESPONSE_RECEIVED", "LLM_RESPONSE_DECODED", "LLM_STRUCTURED_OUTPUT_VALIDATED", "G04_CREATED", "G04_APPROVED", "G04_MODIFICATION_REQUESTED", "G04_REJECTED", "G04_STALE", "COMPATIBILITY_RESOLUTION_STARTED", "COMPATIBILITY_RESOLUTION_COMPLETED", "COMPATIBILITY_RESOLUTION_BLOCKED", "G05_CREATED", "G05_APPROVED", "G05_MODIFICATION_REQUESTED", "G05_REJECTED", "G05_STALE", "PLANNING_INPUT_RESOLUTION_FAILED", "PLANNING_RETRY_SCHEDULED", "PLANNING_FAILED", "MIGRATION_PLAN_CREATED", "STAGE_PLAN_CREATED", "PLAN_REVISION_CREATED", "APPROVAL_MARKED_STALE", "PLANNING_AGENT_COMPLETED", "G06_CREATED", "G06_APPROVED", "G06_MODIFICATION_REQUESTED", "G06_REJECTED", "G06_STALE", "EXECUTION_PROFILE_RESOLUTION_STARTED", "EXECUTION_PROFILE_RESOLVED", "EXECUTION_PROFILE_BLOCKED", "EXECUTION_PROFILE_SELECTED", "BASELINE_WORKSPACE_STARTED", "BASELINE_WORKSPACE_READY", "COMMAND_QUEUED", "COMMAND_STARTED", "COMMAND_SUCCEEDED", "COMMAND_FAILED", "COMMAND_OUTPUT_AVAILABLE", "COMMAND_OUTPUT_CHUNK", "BASELINE_INSTALL_SUCCEEDED", "BASELINE_INSTALL_FAILED", "COMMAND_CANCELLED", "COMMAND_INTERRUPTED", "BASELINE_TARGETS_DISCOVERED", "BASELINE_BUILD_STARTED", "BASELINE_BUILD_COMPLETED", "BASELINE_TESTS_STARTED", "BASELINE_TESTS_COMPLETED", "BASELINE_LINT_STARTED", "BASELINE_LINT_COMPLETED", "BASELINE_QUALIFIED", "G03_CREATED", "G03_APPROVED", "G03_REJECTED", "BASELINE_FAILURES_FINGERPRINTED", "BASELINE_ROUTE_ANCHOR_CREATED", "BASELINE_BACKEND_ANCHOR_CREATED", "DISCOVERY_STARTED", "SCANNER_COMPLETED", "DISCOVERY_COMPLETED", "DISCOVERY_BLOCKED"] as const;
