...
const WORKFLOW_EVENT_TYPES: WorkflowEventType[] = [
  ...
  "SOURCE_INTEGRITY_VERIFIED", "SOURCE_INTEGRITY_FAILED", "COMMAND_QUEUED", "COMMAND_STARTED", "COMMAND_OUTPUT_AVAILABLE", "COMMAND_OUTPUT_CHUNK", "BASELINE_INSTALL_SUCCEEDED", "BASELINE_INSTALL_FAILED", "COMMAND_CANCELLED", "COMMAND_INTERRUPTED", "G02_CREATED", "G02_APPROVED", "G02_REJECTED", "G02_STALE",
];
