# Task 06 — S4-F08-I02 — Persist and expose evidence contracts for Run patch preflight, resume normal validation, and decide G11

## Identity

- Capability goal: `G07`
- Backlog feature: `S4-F08` / `AMFA-218`
- Jira subtask: `AMFA-255`
- Source contract SHA-256: `0cb7a6fbb12d5e1fc5de92c54bcbad2a5a5f3907cb004e97ed406322967e5a31`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/06-S4-F08-I02.json`.
