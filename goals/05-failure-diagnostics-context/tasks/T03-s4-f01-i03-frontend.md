# Task 03 — S4-F01-I03 — Build frontend experience for Capture FailureEvidence and parse deterministic diagnostics

## Identity

- Capability goal: `G05`
- Backlog feature: `S4-F01` / `AMFA-211`
- Jira subtask: `AMFA-228`
- Source contract SHA-256: `4bf96309ad72248bc32d8a464de62c91c8efff13f4f3a04bdfda2e18edc3da30`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/03-S4-F01-I03.json`.
