# Task 06 — S3-F08-I02 — Persist and expose evidence contracts for Capture transformation diffs and classify changed-file risk

## Identity

- Capability goal: `G03`
- Backlog feature: `S3-F08` / `AMFA-147`
- Jira subtask: `AMFA-183`
- Source contract SHA-256: `4e8e23b2bc20917420d212e92dbb24e997ba3a6821b3a3c8263e0b3bad66b4d3`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/06-S3-F08-I02.json`.
