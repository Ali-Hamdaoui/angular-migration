# Task 07 — S4-F08-I03 — Build frontend experience for Run patch preflight, resume normal validation, and decide G11

## Identity

- Capability goal: `G07`
- Backlog feature: `S4-F08` / `AMFA-218`
- Jira subtask: `AMFA-256`
- Source contract SHA-256: `99ecea5df0a0235ec5cdc5aa7dc2cfadf31ca5a929a5682e1f9fd3d45cd873cb`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/07-S4-F08-I03.json`.
