# Manual Runtime Test Plan — G08 Startup Reconciliation and Migration Assistant
...
- Backend: `http://127.0.0.1:8308`
- Frontend: `http://127.0.0.1:3308`
...
- `manual-tests/MT-001-s4-f10-authoritative-scenario.md`
- `manual-tests/MT-002-s4-f11-authoritative-scenario.md`
