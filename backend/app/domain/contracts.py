...
class WorkflowEventType(str, Enum):
    ...
    STAGE_RECOVERY_OPERATION_CREATED = "STAGE_RECOVERY_OPERATION_CREATED"
    STAGE_RECOVERY_OPERATION_RETRIED = "STAGE_RECOVERY_OPERATION_RETRIED"
    STAGE_RECOVERY_REPAIR_REPLAYED = "STAGE_RECOVERY_REPAIR_REPLAYED"
    STAGE_RECOVERY_OPERATION_COMPLETED = "STAGE_RECOVERY_OPERATION_COMPLETED"
    STAGE_RECOVERY_OPERATION_FAILED = "STAGE_RECOVERY_OPERATION_FAILED"
