...
export function BaselineQualificationPanel({runId,stateVersion,workflowEvents=[]}:{runId:string;stateVersion:number;workflowEvents?:Array<{event_type:string}>}) {
 ...
 useEffect(()=>{void getBaselineSummary(runId).then(setAssessment).catch(()=>undefined)},[runId,stateVersion,workflowEvents.length]);
