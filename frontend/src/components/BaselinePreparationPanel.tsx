  ...
  return (
    <section className={styles.panel} aria-labelledby="baseline-preparation-title">
      <div className={styles.header}>
        <div><p className={styles.kicker}>Baseline workspace</p><h2 id="baseline-preparation-title">Baseline workspace</h2><p className={styles.note}>The backend owns the sandbox path, fingerprints, package metadata, and install decision.</p></div>
