# Task 04 — S4-F01-I04 — Verify and document Capture FailureEvidence and parse deterministic diagnostics

## Identity

- Capability goal: `G05`
- Backlog feature: `S4-F01` / `AMFA-211`
- Jira subtask: `AMFA-229`
- Source contract SHA-256: `e32d53ca17429ab1ec0ef1b90f1efd97649176d7df7ddf18093e6e9c68c024fd`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/04-S4-F01-I04.json`.
