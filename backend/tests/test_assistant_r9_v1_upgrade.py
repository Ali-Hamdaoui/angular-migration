...
def test_r9_graph_has_v1_parent_and_reaches_all_heads():
    ...
    # frontend-ups contributes the later planning/command-template chain;
    # the merged graph must expose its terminal head alongside Assistant V1.1.
    assert set(expected_heads(ROOT)) == {"20260727_31", "20260727_19"}
