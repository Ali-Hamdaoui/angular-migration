...
export type CommandPolicyValidateRequestDto = { run_id: string; stage_id: string | null; command_id: string; executable: string; arguments: string[]; working_directory_alias: string | null; working_directory: string | null; execution_profile_id: string; network_profile: string; cancellation_policy: string; timeout_seconds: number; idempotency_key: string; requested_by: string | null };
export type CommandPolicyValidateResponseDto = { authorization_id: string; run_id: string; stage_id: string | null; command_id: string; executable: string; arguments: string[]; decision: string; reasons: string[]; policy_version: string; idempotent_replay: boolean };
