...
describe("AssistantPanel authoritative rendering", () => {
  ...
  it("renders current progress, separated evidence, and authoritative zero usage", async () => {
    ...
    expect(screen.getByText("0 tokens · $0.000000")).toBeInTheDocument();
  });
});
