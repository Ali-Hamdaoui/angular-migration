...
export type PreflightStatus = "passed" | "passed_with_warnings" | "blocked" | "expired";
...
export type PreflightFindingDto = { code: string; severity: PreflightSeverity; message: string };
export type RuntimeCapabilityDto = { tool: string; available: boolean; version: string | null; finding_code: string | null };
export type PreflightResultDto = { run_id: string; status: PreflightStatus; input_checksum: string; expires_at: string; source_path: string; target_output_path: string; findings: PreflightFindingDto[]; capabilities: RuntimeCapabilityDto[]; artifact: ArtifactRefDto | null };
