"""Persistence record for the durable G13 final-assurance boundary."""
...
class FinalAssuranceRecordModel(Base):
    __tablename__ = "final_assurance_records"
    __table_args__ = (
        UniqueConstraint("run_id", "idempotency_key", name="uq_final_assurance_run_idempotency"),
    )
