    ...
    <main className={styles.shell}>
      ...
      {((): React.ReactNode => {
        ...
        return <>
          ...
          <G08ReviewWorkspace runId={runId} stageId={activeStage.stage_id} gateId="G08" expectedStateVersion={state.state_version} connectionStatus={status} onAuthoritativeRefresh={refresh} />
        </>;
      })()}
