...
export type G04DecisionRequest = { expected_state_version: number; idempotency_key: string; gate_version: string; package_artifact_set_checksum: string; decision: G04Decision; comment?: string | null };
