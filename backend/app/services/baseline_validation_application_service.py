...
class BaselineValidationApplicationService:
    ...
    @staticmethod
    def _target_dict(target): return {"target_id": target.target_id, "kind": target.kind.value, "project": target.project, "configuration": target.configuration, "command_id": target.command_id, "executable": target.executable, "arguments": list(target.arguments), "supported": target.supported, "blocker": target.blocker, "builder": target.builder}
    @staticmethod
