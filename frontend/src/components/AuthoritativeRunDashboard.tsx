...
export function AuthoritativeRunDashboard({ runId, initialState }: { runId: string; initialState: AuthoritativeRunStateDto }) {
  ...
  const baselineQualificationAvailable = has("BASELINE_QUALIFIED", "G03_CREATED") || ["BASELINE_BUILD_COMPLETED", "BASELINE_TESTS_COMPLETED", "BASELINE_LINT_COMPLETED"].every((type) => has(type));
