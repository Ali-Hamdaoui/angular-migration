...
export type CommandExecutionResponseDto = { execution_id: string; run_id: string; command_id: string; status: CommandStatus | string; state_version: number; event_sequence: number; idempotent_replay: boolean; stage_id: string | null; authorization_id: string | null; template_id: string | null; template_version: number | null; plan_id: string | null; plan_version: number | null; execution_profile_id: string | null; workspace_alias: string | null; created_at: string | null; started_at: string | null; completed_at: string | null; duration_ms: number | null; exit_code: number | null; failure_code: string | null; correlation_id: string | null; artifact_ids: string[]; request_payload_hash: string | null };
