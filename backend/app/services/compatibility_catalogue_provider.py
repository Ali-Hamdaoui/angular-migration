...
PROVEN_TARGET_COHORTS: dict[tuple[int, int], tuple[str, str, str, str, str]] = {
    ...
    (17, 18): ("18.2.14", "18.2.21", "5.5.4", "6.6.7", "0.14.10"),
    (18, 19): ("19.2.25", "19.2.27", "5.8.3", "6.6.7", "0.15.1"),
    (19, 20): ("20.3.27", "20.3.34", "5.9.3", "6.6.7", "0.15.1"),
    (20, 21): ("21.2.19", "21.2.20", "5.9.3", "6.6.7", "0.15.1"),
}
