...
const state = { run_id: "run-1", state_version: 1, artifacts: [artifact], workflow_events: [], plan_inputs: { source_exact: "18.2.13", source_family: "angular-18.x", target_family: "angular-21.x", catalogue_version: "catalog-v1", input_fingerprint: checksum("c"), execution_profile_id: "profile-1", stage_route: [["angular-18.x", "angular-19.x", "stage-18-to-19", "19.2.0"]], builder: "@angular-devkit/build-angular:application", target_cli_exact: "19.2.0" } } as unknown as AuthoritativeRunStateDto;
