...
const GATE_DEFINITIONS: Record<GateId, GateDefinition> = {
  ...
  G04: gate("G04", "Analysis acceptance", "Confirm discovery facts, risks, unknowns, and support classification."),
  G05: gate("G05", "Feasibility acceptance", "Decide whether the requested migration route may proceed."),
  G06: gate("G06", "Migration plan acceptance", "Lock the execution contract, route, commands, validation, recovery, and delivery strategy."),
