...
describe("G02ReviewPanel", () => {
  it("shows the blocked next step and records approval", async () => {
    ...
    expect(await screen.findByText(/Next step blocked/)).toBeInTheDocument();
