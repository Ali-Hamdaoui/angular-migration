...
const state = { run_id: "run-1", state_version: 3, artifacts: [artifact], source_angular_exact: "18.2.4", registry_snapshot: { snapshot_id: "registry-snap-1", checksum: checksum("x") }, runtime_candidates: [{ profile_id: "node-20-approved", operating_system: "windows", architecture: "amd64", node_exact: "20.11.1", npm_exact: "10.2.4", npx_exact: "10.2.4" }], catalogue_version: "catalog-v1" } as unknown as AuthoritativeRunStateDto;
