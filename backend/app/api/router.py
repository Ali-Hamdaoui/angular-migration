...
# Register gate-specific routers (G07, G03-G06) BEFORE the G02 catch-all
# to avoid G02's /{gate_id} path parameter shadowing literal G07 paths.
...
# Gate-specific routers before G02 catch-all (same reasoning as unversioned api_router)
