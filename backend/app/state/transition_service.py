...
class StateTransitionService:
    ...
    _LEGAL_RUN_TRANSITIONS: dict[WorkflowEventType, frozenset[RunStatus]] = {
        ...
        WorkflowEventType.G05_REJECTED: frozenset({RunStatus.WAITING_PLAN_APPROVAL}),
        WorkflowEventType.G05_MODIFICATION_REQUESTED: frozenset({RunStatus.WAITING_PLAN_APPROVAL}),
        ...
        WorkflowEventType.G06_MODIFICATION_REQUESTED: frozenset({RunStatus.WAITING_PLAN_APPROVAL}),
