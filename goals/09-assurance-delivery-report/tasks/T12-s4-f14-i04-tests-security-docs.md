# Task 12 — S4-F14-I04 — Verify and document Generate, view, download, and accept the final evidence and cost report through G15

## Identity

- Capability goal: `G09`
- Backlog feature: `S4-F14` / `AMFA-224`
- Jira subtask: `AMFA-281`
- Source contract SHA-256: `8a3143a57b8e2a7c787d7c32e576e11cf3e93eaac24cbb4477e684c9d83097ec`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/12-S4-F14-I04.json`.
