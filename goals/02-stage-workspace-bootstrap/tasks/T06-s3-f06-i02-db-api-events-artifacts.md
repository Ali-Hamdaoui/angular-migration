# Task 06 — S3-F06-I02 — Persist and expose evidence contracts for Run the stage bootstrap clean install

## Identity

- Capability goal: `G02`
- Backlog feature: `S3-F06` / `AMFA-145`
- Jira subtask: `AMFA-175`
- Source contract SHA-256: `9b62e1c775e8f609856357f62cce919d5b5fa36f37881df956d9257847477e43`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/06-S3-F06-I02.json`.
