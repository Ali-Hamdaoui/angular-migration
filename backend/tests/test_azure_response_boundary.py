...
@pytest.mark.parametrize("status,subtype", [("failed", "LLM_RESPONSE_FAILED"), ("incomplete", "REFUSAL_OR_INCOMPLETE_RESPONSE"), ("in_progress", "REFUSAL_OR_INCOMPLETE_RESPONSE")])
