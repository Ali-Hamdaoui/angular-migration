...
export type CommandExecuteRequestDto = { command_id: string; executable: string; arguments: string[]; stage_id: string | null; working_directory_alias: string | null; working_directory: string | null; runtime_profile_id: string; timeout_seconds: number; network_profile: string; cancellation_policy: string; idempotency_key: string; requested_by: string | null; requester: string | null };
export type CommandExecutionResponseDto = { execution_id: string; run_id: string; command_id: string; status: string; state_version: number; event_sequence: number; idempotent_replay: boolean };
