# Task 02 — S3-F10-I02 — Persist and expose evidence contracts for Run final clean install and deterministic static checks

## Identity

- Capability goal: `G04`
- Backlog feature: `S3-F10` / `AMFA-149`
- Jira subtask: `AMFA-191`
- Source contract SHA-256: `ce8742804b572d2c2798cec7fbca6e7b3838a6d2f3add09f522bf3b1e59434fe`
...
- Record changed/shared files, tests, artifacts/events, limitations, commit SHA, and reviewer verdict in `evidence/task-results/02-S3-F10-I02.json`.
