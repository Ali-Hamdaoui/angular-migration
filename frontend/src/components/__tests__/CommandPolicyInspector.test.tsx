...
const plan = {
  ...
  stage_plan: { stage_plan_id: "stage-plan-1", stage_id: "stage-1", plan_version: 7, input_fingerprint: "sha256:input", evidence_set_checksum: "sha256:evidence-set", input_workspace_fingerprint: "sha256:workspace", source_family: "angular-18.x", source_exact: "18.2.0", target_family: "angular-19.x", target_exact: "19.2.0", execution_profile_id: "profile-approved", commands: { install: [{ command_id: "npm-ci", template_id: "npm-ci-bootstrap", template_version: 2, parameter_bindings: {}, executable: "npm", arguments: ["ci"], shell: false, working_directory_alias: "BASELINE_SANDBOX", timeout_seconds: 300, network_profile: "approved-registries-only", runtime_profile_checksum: "sha256:runtime", cancellation_policy: "terminate_process_tree", conditional: false }], check: [{ command_id: "ng-version", template_id: "angular-version-verify", template_version: 1, parameter_bindings: {}, executable: "npx", arguments: ["ng", "version"], shell: false, working_directory_alias: "BASELINE_SANDBOX", timeout_seconds: 60, network_profile: "none", runtime_profile_checksum: "sha256:runtime", cancellation_policy: "terminate_process_tree", conditional: false }] }, build_system_decision: {}, validation_policy: {}, recovery_policy: {}, repair_policy: {}, forbidden_change_policy: {}, checksum: "sha256:stage" }, plan_checksum: "sha256:plan", stage_plan_checksum: "sha256:stage", artifact_ids: ["auth-plan"], artifact_checksums: { "auth-plan": "sha256:evidence" }, artifact_links: { "auth-plan": "/api/v1/artifacts/auth-plan" }, builder_decision: {}, state_version: 7, event_sequence: 3, idempotent_replay: false,
} as never;
